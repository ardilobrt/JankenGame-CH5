...
class ThirdOnBoardingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.ivOnBoarding.setImageResource(R.drawable.ic_onboarding_3)
        binding.tvTitle.text = resources.getString(R.string.title_vs_cpu)
        binding.ivDescription.text = resources.getString(R.string.desc_vs_cpu)
